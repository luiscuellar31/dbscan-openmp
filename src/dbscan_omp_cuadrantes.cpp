/*
  DBSCAN (OpenMP - "cuadrantes")
  Autor: @luiscuellar31

  Idea:
  - Misma lógica que la versión indivisible, pero con reparto estático por bloques
    contiguos (pensado para 4 hilos como “cuadrantes” lógicos). La BFS se mantiene
    secuencial para preservar simplicidad y evitar carreras.
  ...
  Uso típico:
    OMP_NUM_THREADS=4 ./dbscan_omp_cuadrantes data/input/4000_data.csv
*/
#include <iostream>
#include <vector>
#include <queue>
